...
def test_open_gerber(self):
    ...
    self.assertTrue(
        ...
        "Expected FlatCAMGerber, instead, %s is %s" % (self.gerber_top_name, type(gerber_top_obj)),
    )
    ...
    self.fc.exec_command_test("open_gerber %s/%s" % (self.gerber_files, self.copper_top_filename))
