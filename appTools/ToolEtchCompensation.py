...
class ToolEtchCompensation(AppTool):
    ...
    def reset_fields(self):
        self.ui.gerber_combo.setRootModelIndex(
...
class EtchUI:
    ...
    def __init__(self, layout, app):
        ...
        self.thick_label.setToolTip(_("The thickness of the copper foil.\n" "In microns [um]."))
        ...
        self.etchants_label.setToolTip(_("A list of etchants."))
