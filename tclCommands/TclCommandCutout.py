...
class TclCommandCutout(TclCommand):
    ...
    help = {
        ...
        "args": collections.OrderedDict(
            [
                ...
                (
                    "gaps",
                    "Type of gaps. Can be: 'tb' = top-bottom, 'lr' = left-right and '4' = one each side.",
                ),
    ...
    def execute(self, args, unnamed_args):
        ...
        def geo_init_me(geo_obj, app_obj):
            ...
            cases = {
                "tb": [[pts[0], pts[1], pts[4], pts[5]], [pts[6], pts[7], pts[10], pts[11]]],
                "lr": [[pts[9], pts[10], pts[1], pts[2]], [pts[3], pts[4], pts[7], pts[8]]],
                "4": [
                    [pts[0], pts[1], pts[2]],
                    [pts[3], pts[4], pts[5]],
                    [pts[6], pts[7], pts[8]],
