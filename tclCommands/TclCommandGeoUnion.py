...
class TclCommandGeoUnion(TclCommand):
    ...
    description = "%s %s" % (
        "--",
        "Run the Union (join) geometry operation on the elements of a Geometry object.",
    )
    ...
    help = {
        "main": (
            "Runs a union operation (addition) on the components "
        ...
        "args": collections.OrderedDict(
            [
                (
                    "name",
                    "Name of the Geometry Object that contain the components to be joined. Required.",
                ),
            ]
        ),
