...
class TclCommandMillSlots(TclCommandSignaled):
    ...
    help = {
        ...
        "args": collections.OrderedDict(
            [
                ...
                (
                    "milled_dias",
                    "Comma separated tool diameters of the slots to be milled (example: 0.6, 1.0 or 3.125).\n"
                ...
                (
                    "diatol",
                    "Tolerance. Percentange (0.0 ... 100.0) within which dias in milled_dias will be judged to be "
        ...
        "examples": [
            'millslots myslots -milled_dias "0.6,0.8" -tooldia 0.1 -diatol 10 -outname milled_slots',
    ...
    def execute(self, args, unnamed_args):
            ...
            if "milled_dias" in args and args["milled_dias"] != "all":
                ...
                if nr_diameters > 0:
                    self.raise_tcl_error(
                        "One or more tool diameters of the slots to be milled passed to the "
        ...
        if obj.kind != "excellon":
            self.raise_tcl_error(
                "Only Excellon objects can have mill-slots, got %s %s." % (name, type(obj))
            )
