...
class TclCommandPlotObjects(TclCommand):
    ...
    arg_names = collections.OrderedDict([("names", str)])

    # Dictionary of types from Tcl command, needs to be ordered , this  is  for options  like -optionname value
    option_types = collections.OrderedDict([("plot_status", str)])
    ...
    help = {
        ...
        "args": collections.OrderedDict(
            [
                (
                    "names",
                    "A list of object names to be plotted separated by comma. Required.\n"
