    ...
    help = {
        ...
        "args": collections.OrderedDict(
            [
                ...
                (
                    "milled_dias",
                    "Comma separated tool diameters of the drills to be milled (example: 0.6, 1.0 or 3.125).\n"
        ...
        "examples": [
            'milldrills mydrills -milled_dias "0.6,0.8" -tooldia 0.1 -diatol 10 -outname milled_holes',
            ...
            if "milled_dias" in args and args["milled_dias"] != "all":
                ...
                if nr_diameters > 0:
                    self.raise_tcl_error(
                        "One or more tool diameters of the drills to be milled passed to the "
