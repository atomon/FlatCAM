    ...
    help = {
        ...
        "args": collections.OrderedDict(
            [
                ...
                (
                    "holes",
                    "Tuple of tuples where each tuple it is a set of x, y coordinates. "
                    "E.g: (x0, y0), (x1, y1), ... ",
                ),
                (
                    "grid",
                    "Aligning to grid, for those, who have aligning pins"
        ...
        "examples": [
            "aligndrill my_object -axis X -box my_object -dia 3.125 -grid 1 "
