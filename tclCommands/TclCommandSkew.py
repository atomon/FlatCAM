...
class TclCommandSkew(TclCommand):
    ...
    description = "%s %s" % (
        "--",
        "Will deform (skew) the geometry of a named object. Does not create a new object.",
    )
    ...
    option_types = collections.OrderedDict([("x", float), ("y", float)])
    ...
    help = {
        ...
        "args": collections.OrderedDict(
            [
                (
                    "name",
                    "Name of the object (Gerber, Geometry or Excellon) to be deformed (skewed). Required.",
                ),
                (
                    "x",
                    "Angle in degrees by which to skew on the X axis. If it is not used it will be assumed to be 0.0",
                ),
                (
                    "y",
                    "Angle in degrees by which to skew on the Y axis. If it is not used it will be assumed to be 0.0",
                ),
            ]
        ),
