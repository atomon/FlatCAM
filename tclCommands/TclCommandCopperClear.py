...
class TclCommandCopperClear(TclCommand):
    ...
    help = {
        ...
        "args": collections.OrderedDict(
            [
                ...
                (
                    "tooldia",
                    "Diameter of the tool to be used. Can be a comma separated list of diameters.\n"
                ...
                (
                    "offset",
                    "If used, the copper clearing will finish to a distance from copper features. Float number.",
                ),
                (
                    "all",
                    'If used will copper clear the whole object. Either "-all" or "-box <value>" has to be used.',
                ),
                (
                    "box",
                    'Name of the object to be used as reference. Either "-all" or "-box <value>" has to be used. '
                    "String.",
                ),
    ...
    def execute(self, args, unnamed_args):
        ...
        if "all" in args:
            self.app.ncclear_tool.clear_copper_tcl(
                ncc_obj=obj,
