...
class ObjectUI(QtWidgets.QWidget):
    ...
    def __init__(
        self,
        app,
        icon_file="assets/resources/flatcam_icon32.png",
        title=_("App Object"),
        parent=None,
        common=True,
    ):
        ...
        if common is True:
            ...
            self.transform_label.setToolTip(_("Geometrical transformations of the current object."))
            ...
            self.offset_button.setToolTip(_("Perform the offset operation."))
            ...
            self.transformations_button.setIcon(
...
class GerberObjectUI(ObjectUI):
    ...
    def __init__(self, app, parent=None):
        ...
        self.solid_cb.setToolTip(_("Solid color polygons."))
        grid0.addWidget(self.solid_cb, 0, 1)

        # Multicolored CB
        self.multicolored_cb = FCCheckBox(label=_("Multi-Color"))
        self.multicolored_cb.setToolTip(_("Draw polygons in different colors."))
        ...
        self.properties_button.setIcon(
            QtGui.QIcon(self.app.resource_location + "/properties32.png")
        )
        ...
        self.generate_cutout_button.setIcon(
            QtGui.QIcon(self.app.resource_location + "/cut32_bis.png")
        )
        self.generate_cutout_button.setToolTip(_("Generate the geometry for\n" "the board cutout."))
        ...
        self.generate_noncopper_button.setIcon(
        ...
        self.generate_bb_button.setToolTip(_("Generate the Geometry object."))
...
class ExcellonObjectUI(ObjectUI):
    ...
    def __init__(self, app, parent=None):
        ...
        # Solid CB
        self.solid_cb = FCCheckBox(label=_("Solid"))
        self.solid_cb.setToolTip(_("Solid circles."))
        ...
        self.tools_table.setHorizontalHeaderLabels(
            ["#", _("Diameter"), _("Drills"), _("Slots"), "C", "P"]
        )
        ...
        self.tdlabel.setToolTip(_("Diameter of the cutting tool."))
...
class GeometryObjectUI(ObjectUI):
    ...
    def __init__(self, app, parent=None):
        ...
        super(GeometryObjectUI, self).__init__(
            ...
            icon_file=self.resource_loc + "/geometry32.png",
            parent=parent,
            app=self.app,
        )
        ...
        self.geo_tools_table.setHorizontalHeaderLabels(
            ["#", _("Dia"), _("Offset"), _("Type"), _("TT"), "", "P"]
        )
        ...
        self.addtool_entry_lbl.setToolTip(_("Diameter for the new tool"))
        ...
        self.tipdialabel.setToolTip(_("The tip diameter for V-Shape Tool"))
        ...
        self.tipanglelabel.setToolTip(_("The tip angle for V-Shape Tool.\n" "In degree."))
        ...
        self.cutzlabel.setToolTip(_("Cutting depth (negative)\n" "below the copper surface."))
        ...
        self.travelzlabel.setToolTip(_("Height of the tool when\n" "moving without cutting."))
        ...
        self.frlabel.setToolTip(_("Cutting speed in the XY\n" "plane in units per minute"))
        ...
        self.polish_dia_lbl.setToolTip(_("Diameter for the polishing tool."))
        ...
        self.polish_travelz_lbl.setToolTip(_("Height of the tool when\n" "moving without cutting."))
        ...
        self.polish_margin_lbl.setToolTip(_("Bounding box margin."))
        ...
        self.polish_method_combo.addItems([_("Standard"), _("Seed"), _("Lines")])
        ...
        self.tools_label.setToolTip(_("Launch Paint Tool in Tools Tab."))
        self.grid4.addWidget(self.tools_label, 32, 0, 1, 2)

        # Milling Tool - will create GCode for slot holes
        self.milling_button = FCButton(_("Milling Tool"))
        self.milling_button.setIcon(QtGui.QIcon(self.app.resource_location + "/milling_tool32.png"))
        self.milling_button.setToolTip(_("Generate a CNCJob by milling a Geometry."))
        self.milling_button.setStyleSheet(
            """
                        QPushButton
                        {
...
class CNCObjectUI(ObjectUI):
    ...
    def __init__(self, app, parent=None):
        ...
        ObjectUI.__init__(
            self,
            title=_("CNC Job Object"),
            icon_file=self.resource_loc + "/cnc32.png",
            parent=parent,
            app=self.app,
        )
        ...
        self.cnc_tools_table.setHorizontalHeaderLabels(
            ["#", _("Dia"), _("Offset"), _("Type"), _("TT"), "", _("P")]
        )
        ...
        self.exc_cnc_tools_table.setHorizontalHeaderLabels(
            ["#", _("Dia"), _("Drills"), _("Slots"), "", _("Cut Z"), _("P")]
        )
        ...
        self.updateplot_button.setToolTip(_("Update the plot."))
        ...
        self.sal_btn.setToolTip(_("Enable the autolevelling feature."))
        ...
        self.al_probe_points_table.setHorizontalHeaderLabels(
            ["#", _("X-Y Coordinates"), _("Height")]
        )
        ...
        self.ptravelz_label.setToolTip(_("The safe Z for probe travelling between probe points."))
        ...
        self.al_mode_radio = RadioSet(
            [{"label": _("Manual"), "value": "manual"}, {"label": _("Grid"), "value": "grid"}]
        )
        ...
        self.al_method_radio = RadioSet(
            [{"label": _("Voronoi"), "value": "v"}, {"label": _("Bilinear"), "value": "b"}]
        )
        ...
        self.al_columns_label.setToolTip(_("The number of grid columns."))
        ...
        self.al_rows_label.setToolTip(_("The number of grid rows."))
        ...
        self.com_list_label.setToolTip(_("Lists the available serial ports."))

        self.com_list_combo = FCComboBox()
        self.com_search_button = FCButton(_("Search"))
        self.com_search_button.setToolTip(_("Search for the available serial ports."))
        ...
        self.baudrates_list_label.setToolTip(_("Lists the available serial ports."))
        ...
        self.new_bd_label.setToolTip(_("New, custom baudrate."))

        self.new_baudrate_entry = FCSpinner()
        self.new_baudrate_entry.set_range(40, 9999999)

        self.add_bd_button = FCButton(_("Add"))
        self.add_bd_button.setToolTip(_("Add the specified custom baudrate to the list."))
        ...
        self.controller_reset_button.setToolTip(_("Software reset of the controller."))
        ...
        self.pause_resume_button.setSizePolicy(
        ...
        self.jog_step_label.setToolTip(_("Each jog action will move the axes with this value."))
        ...
        self.jog_fr_label.setToolTip(_("Feedrate when jogging."))
        ...
        self.grbl_command_label.setToolTip(_("Send a custom command to GRBL."))
        ...
        self.grbl_send_button.setToolTip(_("Send a custom command to GRBL."))
        ...
        self.grbl_get_param_label.setToolTip(_("A GRBL configuration parameter."))
        ...
        self.grbl_get_param_button.setToolTip(_("Get the value of a specified GRBL parameter."))
        ...
        self.grbl_report_button.setToolTip(_("Print in shell the GRBL report."))
        ...
        self.grbl_save_height_map_button.setIcon(
            QtGui.QIcon(self.app.resource_location + "/save_as.png")
        )
        self.grbl_save_height_map_button.setToolTip(_("Will save the GRBL height map."))
        ...
        self.h_gcode_button.setToolTip(_("Will save the probing GCode."))
        self.h_gcode_button.setSizePolicy(
            QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.MinimumExpanding
        )

        height_lay.addWidget(self.h_gcode_button)
        self.view_h_gcode_button = QtWidgets.QToolButton()
        self.view_h_gcode_button.setIcon(
            QtGui.QIcon(self.app.resource_location + "/edit_file32.png")
        )
        # self.view_h_gcode_button.setSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Ignored)
        self.view_h_gcode_button.setToolTip(_("View/Edit the probing GCode."))
        ...
        self.export_gcode_button.setToolTip(_("Opens dialog to save G-Code\n" "file."))
        self.export_gcode_button.setSizePolicy(
...
class DocumentObjectUI(ObjectUI):
    ...
    def __init__(self, app, parent=None):
        ...
        self.font_color_label.setToolTip(_("Set the font color for the selected text"))
        ...
        self.sel_color_label.setToolTip(_("Set the selection color when doing text selection."))
