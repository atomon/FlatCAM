...
class ExcellonEditorPrefGroupUI(OptionsGroupUI):
    def __init__(self, decimals=4, parent=None):
        ...
        self.param_label.setToolTip(_("A list of Excellon Editor parameters."))
        ...
        self.drill_circular_dir_radio = RadioSet(
        ...
        self.drill_array_size_label.setToolTip(_("Specify how many slots to be in the array."))
        ...
        self.slot_array_circular_dir_radio = RadioSet(
            [{"label": _("CW"), "value": "CW"}, {"label": _("CCW"), "value": "CCW"}]
        )
