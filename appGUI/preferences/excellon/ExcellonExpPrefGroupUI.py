...
class ExcellonExpPrefGroupUI(OptionsGroupUI):
    ...
    def __init__(self, decimals=4, parent=None):
        ...
        self.excellon_units_label.setToolTip(_("The units used in the Excellon file."))

        self.excellon_units_radio = RadioSet(
            [{"label": _("Inch"), "value": "INCH"}, {"label": _("mm"), "value": "METRIC"}]
        )
        self.excellon_units_radio.setToolTip(_("The units used in the Excellon file."))
        ...
        self.format_radio = RadioSet(
            [{"label": _("Decimal"), "value": "dec"}, {"label": _("No-Decimal"), "value": "ndec"}]
        )
        ...
        self.zeros_radio = RadioSet(
            [{"label": _("LZ"), "value": "LZ"}, {"label": _("TZ"), "value": "TZ"}]
        )
        ...
        self.slot_type_radio = RadioSet(
            [
                {"label": _("Routed"), "value": "routing"},
