...
class CNCJobAdvOptPrefGroupUI(OptionsGroupUI):
    def __init__(self, decimals=4, parent=None):
        ...
        self.annotation_color_label.setToolTip(_("Set the font color for the annotation texts."))
        ...
        self.autolevelling_gcode_label.setToolTip(_("Parameters for the autolevelling."))
        ...
        self.jog_travelz_label.setToolTip(_("Safe height (Z) distance when jogging to origin."))
    ...
    def on_annotation_fontcolor_entry(self):
        self.app.defaults["cncjob_annotation_fontcolor"] = (
            self.annotation_fontcolor_entry.get_value()
        )
