...
class CNCJobGenPrefGroupUI(OptionsGroupUI):
    def __init__(self, decimals=4, parent=None):
        ...
        tdlabel.setToolTip(_("The width of the travel lines to be\n" "rendered in the plot."))
        ...
        self.coords_type_radio = RadioSet(
            [{"label": _("Absolute"), "value": "G90"}, {"label": _("Incremental"), "value": "G91"}],
        ...
        self.tline_color_label.setToolTip(_("Set the travel line color for plotted objects."))
        ...
        self.cncjob_alpha_label.setToolTip(_("Set the fill transparency for plotted objects."))
        ...
        self.line_color_label.setToolTip(_("Set the color for plotted objects."))
    ...
    def on_tfill_color_entry(self):
        self.app.defaults["cncjob_travel_fill"] = (
            self.tfill_color_entry.get_value()[:7] + self.app.defaults["cncjob_travel_fill"][7:9]
        )

    def on_tline_color_entry(self):
        self.app.defaults["cncjob_travel_line"] = (
            self.tline_color_entry.get_value()[:7] + self.app.defaults["cncjob_travel_line"][7:9]
        )

    def on_cncjob_alpha_changed(self, spinner_value):
        self.app.defaults["cncjob_travel_fill"] = self.app.defaults["cncjob_travel_fill"][:7] + (
            hex(spinner_value)[2:] if int(hex(spinner_value)[2:], 16) > 0 else "00"
        )
        self.app.defaults["cncjob_travel_line"] = self.app.defaults["cncjob_travel_line"][:7] + (
            hex(spinner_value)[2:] if int(hex(spinner_value)[2:], 16) > 0 else "00"
        )
    ...
    def on_fill_color_entry(self):
        self.app.defaults["cncjob_plot_fill"] = (
            self.fill_color_entry.get_value()[:7] + self.app.defaults["cncjob_plot_fill"][7:9]
        )

    def on_line_color_entry(self):
        self.app.defaults["cncjob_plot_line"] = (
            self.line_color_entry.get_value()[:7] + self.app.defaults["cncjob_plot_line"][7:9]
        )
