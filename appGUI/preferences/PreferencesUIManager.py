...
class PreferencesUIManager:
    ...
    def __init__(self, defaults: FlatCAMDefaults, data_path: str, ui, inform):
        ...
        self.defaults_form_fields = {
            ...
            "gerber_editor_circ_angle": self.ui.gerber_defaults_form.gerber_editor_group.grb_circular_angle_entry,
            ...
            "excellon_editor_circ_angle": self.ui.excellon_defaults_form.excellon_editor_group.drill_circular_angle_entry,
            # Excellon Slots
            "excellon_editor_slot_direction": self.ui.excellon_defaults_form.excellon_editor_group.slot_axis_radio,
            "excellon_editor_slot_angle": self.ui.excellon_defaults_form.excellon_editor_group.slot_angle_spinner,
            "excellon_editor_slot_length": self.ui.excellon_defaults_form.excellon_editor_group.slot_length_entry,
            # Excellon Slots
            "excellon_editor_slot_array_size": self.ui.excellon_defaults_form.excellon_editor_group.slot_array_size_entry,
            "excellon_editor_slot_lin_dir": self.ui.excellon_defaults_form.excellon_editor_group.slot_array_axis_radio,
            "excellon_editor_slot_lin_pitch": self.ui.excellon_defaults_form.excellon_editor_group.slot_array_pitch_entry,
            "excellon_editor_slot_lin_angle": self.ui.excellon_defaults_form.excellon_editor_group.slot_array_angle_entry,
            "excellon_editor_slot_circ_dir": self.ui.excellon_defaults_form.excellon_editor_group.slot_array_circular_dir_radio,
            "excellon_editor_slot_circ_angle": self.ui.excellon_defaults_form.excellon_editor_group.slot_array_circular_angle_entry,
            # Geometry General
            ...
            "tools_copper_thieving_squares_spacing": self.ui.tools2_defaults_form.tools2_cfill_group.squares_spacing_entry,
    ...
    def defaults_write_form(self, factor=None, fl_units=None, source_dict=None):
        ...
        for option in options_storage:
            if source_dict:
                self.defaults_write_form_field(
                    option, factor=factor, units=fl_units, defaults_dict=source_dict
                )
            else:
    ...
    def defaults_write_form_field(self, field, factor=None, units=None, defaults_dict=None):
        ...
        try:
            ...
            elif (units == "IN" or units == "MM") and (
                field == "global_gridx" or field == "global_gridy"
            ):
                form_field.set_value(value)
    ...
    def __init_color_pickers(self):
        ...
        self.ui.gerber_defaults_form.gerber_gen_group.fill_color_entry.set_value(
            self.defaults["gerber_plot_fill"]
        )
        self.ui.gerber_defaults_form.gerber_gen_group.line_color_entry.set_value(
            self.defaults["gerber_plot_line"]
        )
        ...
        self.ui.general_defaults_form.general_gui_group.sf_color_entry.set_value(
            self.defaults["global_sel_fill"]
        )
        self.ui.general_defaults_form.general_gui_group.sl_color_entry.set_value(
    ...
    def on_save_button(self, save_to_file=True):
        ...
        self.ui.pref_apply_button.setIcon(
            QtGui.QIcon(self.ui.app.resource_location + "/apply32.png")
        )
        ...
        if save_to_file or should_restart is True:
            ...
            self.defaults.load(
                filename=os.path.join(self.data_path, "current_defaults.FlatConfig"),
                inform=self.inform,
            )
    ...
    def on_preferences_edited(self):
        ...
        if self.preferences_changed_flag is False:
            ...
            self.ui.pref_apply_button.setIcon(
                QtGui.QIcon(self.ui.app.resource_location + "/apply_red32.png")
            )
    ...
    def on_close_preferences_tab(self):
        ...
        if self.preferences_changed_flag is True:
            msgbox = QtWidgets.QMessageBox()
            msgbox.setText(
                _("One or more values are changed.\n" "Do you want to save the Preferences?")
            )
