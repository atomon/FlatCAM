...
class ToolsNCCPrefGroupUI(OptionsGroupUI):
    def __init__(self, decimals=4, parent=None):
        ...
        self.tool_type_label.setToolTip(_("Default tool type:\n" "- 'V-shape'\n" "- Circular"))

        self.tool_type_radio = RadioSet(
            [{"label": _("V-shape"), "value": "V"}, {"label": _("Circular"), "value": "C1"}]
        )
        self.tool_type_radio.setToolTip(_("Default tool type:\n" "- 'V-shape'\n" "- Circular"))
