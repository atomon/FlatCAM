...
class ToolsFilmPrefGroupUI(OptionsGroupUI):
    def __init__(self, decimals=4, parent=None):
        ...
        self.film_type_radio = RadioSet(
            [{"label": "Pos", "value": "pos"}, {"label": "Neg", "value": "neg"}]
        )
        ...
        self.film_color_label.setToolTip(_("Set the film color when positive film is selected."))
