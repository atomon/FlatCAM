...
class GeneralAppPrefGroupUI(OptionsGroupUI):
    def __init__(self, decimals=4, parent=None):
        ...
        # Units for FlatCAM
        self.unitslabel = QtWidgets.QLabel(
            '<span style="color:red;"><b>%s:</b></span>' % _("Units")
        )
        self.unitslabel.setToolTip(
            _(
        ...
        self.units_radio = RadioSet(
            [{"label": _("MM"), "value": "MM"}, {"label": _("IN"), "value": "IN"}]
        )
        ...
        self.ge_radio = RadioSet(
            [{"label": _("Legacy(2D)"), "value": "2D"}, {"label": _("OpenGL(3D)"), "value": "3D"}],
        ...
        self.app_level_label = QtWidgets.QLabel(
            '<span style="color:red;"><b>%s:</b></span>' % _("APPLICATION LEVEL")
        )
        self.app_level_label.setToolTip(
            _(
        ...
        self.app_level_radio = RadioSet(
            [{"label": _("Basic"), "value": "b"}, {"label": _("Advanced"), "value": "a"}]
        )
        ...
        self.portability_cb.setToolTip(
            _(
        ...
        self.language_apply_btn.setToolTip(
            _("Set the language used throughout FlatCAM.\n" "The app will restart after click.")
        )
        ...
        self.splash_cb.setToolTip(_("Enable display of the splash screen at application startup."))
        ...
        self.systray_cb.setToolTip(_("Enable display of FlatCAM icon in Sys Tray."))
        ...
        self.proj_ois = OptionalInputSection(
            self.save_type_cb, [self.compress_label, self.compress_spinner], True
        )
        ...
        self.tmargin_label.setToolTip(_("Distance between text body and the top of the PDF file."))
        ...
        self.lmargin_label.setToolTip(_("Distance between text body and the left of the PDF file."))
        ...
        self.language_apply_btn.clicked.connect(
            lambda: fcTranslate.on_language_apply_click(app=self.app, restart=True)
        )
