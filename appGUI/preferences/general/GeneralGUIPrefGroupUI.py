...
class GeneralGUIPrefGroupUI(OptionsGroupUI):
    def __init__(self, decimals=4, parent=None):
        ...
        self.theme_radio = RadioSet(
            [{"label": _("Light"), "value": "white"}, {"label": _("Dark"), "value": "black"}],
        ...
        # find current style
        index = self.style_combo.findText(
            QtWidgets.qApp.style().objectName(), QtCore.Qt.MatchFixedString
        )
        ...
        self.alt_sf_color_label.setToolTip(_("Set the color for the shape."))
        ...
        self.sel_draw_color_label.setToolTip(_("Set the color of the shape when selected."))
        ...
        self.proj_color_label.setToolTip(_("Set the color of the items in Project Tab Tree."))
    ...
    def on_sl_color_entry(self):
        self.app.defaults["global_sel_line"] = (
            self.sl_color_entry.get_value()[:7] + self.app.defaults["global_sel_line"][7:9]
        )
    ...
    def on_alt_sf_color_entry(self):
        self.app.defaults["global_alt_sel_fill"] = (
            self.alt_sf_color_entry.get_value()[:7] + self.app.defaults["global_alt_sel_fill"][7:9]
        )

    def on_alt_sl_color_entry(self):
        self.app.defaults["global_alt_sel_line"] = (
            self.alt_sl_color_entry.get_value()[:7] + self.app.defaults["global_alt_sel_line"][7:9]
        )
