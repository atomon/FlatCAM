...
class GeneralAppSettingsGroupUI(OptionsGroupUI2):
    def __init__(self, decimals=4, **kwargs):
        ...
        self.workspace_orientation_field = self.option_dict()[
            "global_workspace_orientation"
        ].get_field()
        self.workspace_orientation_label = self.option_dict()[
            "global_workspace_orientation"
        ].label_widget
        ...
        self.mouse_cursor_color_enabled_field = self.option_dict()[
        ...
        self.mois = OptionalInputSection(
            ...
            [self.mouse_cursor_color_label, self.mouse_cursor_color_field],
        )
        self.mouse_cursor_color_enabled_field.stateChanged.connect(
            self.on_mouse_cursor_color_enable
        )
    ...
    def build_options(self) -> [OptionUI]:
        return [
            ...
            RadioSetOptionUI(
                ...
                choices=[{"label": _("MMB"), "value": "3"}, {"label": _("RMB"), "value": "2"}],
            ),
            RadioSetOptionUI(
