...
class GeneralAPPSetGroupUI(OptionsGroupUI):
    def __init__(self, decimals=4, parent=None):
        ...
        self.gridx_label.setToolTip(_("This is the Grid snap value on X axis."))
        ...
        self.gridy_label.setToolTip(_("This is the Grid snap value on Y axis."))
        ...
        self.wk_orientation_radio = RadioSet(
            [
        ...
        if qsettings.contains("notebook_font_size"):
            self.notebook_font_size_spinner.set_value(
                qsettings.value("notebook_font_size", type=int)
            )
        else:
        ...
        self.axis_font_size_label.setToolTip(_("This sets the font size for canvas axis."))
        ...
        self.hud_font_size_label.setToolTip(_("This sets the font size for the Heads Up Display."))
        ...
        self.cursor_radio = RadioSet(
            [{"label": _("Small"), "value": "small"}, {"label": _("Big"), "value": "big"}],
        ...
        self.cursor_size_lbl.setToolTip(_("Set the size of the mouse cursor, in pixels."))
        ...
        self.cursor_width_lbl.setToolTip(_("Set the line width of the mouse cursor, in pixels."))
        ...
        self.mouse_cursor_color_cb.setToolTip(_("Check this box to color mouse cursor."))
        grid0.addWidget(self.mouse_cursor_color_cb, 25, 0, 1, 2)

        # Cursor Color
        self.mouse_color_label = QtWidgets.QLabel("%s:" % _("Cursor Color"))
        self.mouse_color_label.setToolTip(_("Set the color of the mouse cursor."))
        ...
        self.mois = OptionalInputSection(
            self.mouse_cursor_color_cb, [self.mouse_color_label, self.mouse_cursor_entry]
        )
        ...
        self.pan_button_radio = RadioSet(
            [{"label": _("MMB"), "value": "3"}, {"label": _("RMB"), "value": "2"}]
        )
        ...
        self.mselect_radio = RadioSet(
            [{"label": _("CTRL"), "value": "Control"}, {"label": _("SHIFT"), "value": "Shift"}]
        )
