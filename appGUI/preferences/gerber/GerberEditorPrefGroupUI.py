...
class GerberEditorPrefGroupUI(OptionsGroupUI):
    def __init__(self, decimals=4, parent=None):
        ...
        self.param_label.setToolTip(_("A list of Gerber Editor parameters."))
        ...
        self.addcode_entry_lbl.setToolTip(_("Code for the new aperture"))
        ...
        self.addsize_entry_lbl.setToolTip(_("Size for the new aperture"))
        ...
        self.grb_array_size_label.setToolTip(_("Specify how many pads to be in the array."))
        ...
        self.grb_pitch_label.setToolTip(_("Pitch = Distance between elements of the array."))
        ...
        self.grb_circular_dir_radio = RadioSet(
        ...
        self.grb_buff_label.setToolTip(_("Distance at which to buffer the Gerber element."))
        ...
        self.grb_scale_label.setToolTip(_("Factor to scale the Gerber element."))
